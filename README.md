...
4. [.NET Core SDK](https://www.microsoft.com/net/download) - **Please make sure you install version 3.1.100** - The latest version is 3.1.101, but we are waiting on Reinforced.Typings to support this version before we update the ETA's SDK version. You will need to choose Advanced -> All .NET Core Downloads to install the 3.1.100 version.
