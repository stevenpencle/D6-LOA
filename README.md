...
4. [.NET Core SDK](https://www.microsoft.com/net/download) - **Please make sure you install version 3.1.100 and 3.1.102** - The latest version is 3.1.102, but Reinforced.Typings currently depends on the 3.1.100 SDK version. You will need to choose Advanced -> All .NET Core Downloads to install the 3.1.100 and 3.1.102 version.
...
The only purpose of this file is to specify which SDK version to use for building the .NET Core application. Currently, the ETA is targeting the latest SDK version 3.1.102. The ETA is kept current with .NET Core versions.
